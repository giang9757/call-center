        ...
        <div class="container-fluid" id='header-bar'>
            ...
            <div class="pull-right" role="navigation">
                <div class="dropdown-ext">
                    ...
                    ?>
                    <div class="dropdown-menu last-login dropdown-menu-ext dropdown-menu-right" role="menu">
                        The last logged in at: <br><?= date("Y-m-d H:i:s", $user->session_login)?>
                    </div>
                </div>
            ...
            <div class='menu-list'>
                ...
                ?>
                    <li class="collapse-item">
                        <a href="#" class='display-inline' data-sidebar="toggleCollapse">
